...
<body>
<header class="topbar">
    <a class="brand" href="#">Online Gallery</a>
...
<main class="page">
    <section class="hero">
        ...
        <p>Делитесь кадрами в исходном качестве, оставляйте реакции и обсуждайте их вместе.</p>
    </section>
    <section id="upload-area" class="upload hidden">
        ...
        <form id="upload-form">
            ...
            <label>Заголовок <textarea name="caption" maxlength="120" placeholder="Необязательно: короткое название кадра"></textarea></label>
